         ...
         //casesTableBody.innerHTML = null;
          ...
          data.forEach((caseData) => {
           ...
           /* row.innerHTML = `
            ...
            row.innerHTML = `
            <td>${caseData.TransID}</td>
            <td>${caseData.DocketNo}</td>
            <td>${caseData.cat}</td>
            <td>${caseData.SubCat}</td>
            <td>${caseData.ProblemDescription}</td>
            <td>${caseData.Status}</td>
            <td>${caseData.AssignedTo}</td>
            <td>${caseData.i_TechStaffId}</td>
            <td>${caseData.Source}</td>
            <td>${caseData.ReportedDate}</td>
            <td>${caseData.ReportedTime}</td>
            <td>${caseData.ResolvedDate}</td>
            <td>${caseData.ResolvedTime}</td>
            <td>${caseData.CustomerName}</td>
            <td>${caseData.Phone}</td>
            <td>${caseData.AssignedToName}</td>
            <td>${caseData.BillingStreet}</td>
            <td>${caseData.audioFile}</td>
            <td>${caseData.ImageFile}</td>
            <td>${caseData.latitude}</td>
            <td>${caseData.longitude}</td>
            <td>${caseData.Calltype}</td>
            <td>${caseData.i_notication_flag}</td>
            <td>${caseData.v_AreaName}</td>
            <td>${caseData.Zone_Name}</td>
            <td>${caseData.v_HouseNo}</td>
            <td>${caseData.Urgency}</td>
            <td>${caseData.DeadLineDate}</td>
          `;
